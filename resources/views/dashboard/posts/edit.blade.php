    ...
    <div class="flex flex-wrap items-top gap-8 w-full justify-between">
        <div class="flex flex-col gap-8 w-full lg:w-8/12">
            ...
            <div class="flex items-center gap-4">
                ...
                <span class="flex gap-4 items-center"><h2 class="font-black text-black inline-block">CEdit post</h2></span>
            </div>
                ...
                <form method="POST" action="{{ '/posts/update' }}" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col gap-8">
                        ...
                        <div>
                            {{-- <label>
                                <div class="">
                                    <textarea name="content" id="post_content" class="w-full border-gray-300 h-64 shadow" placeholder="Edit post"></textarea>
                                </div>
                            </label> --}}
                        </div>
                    </div>
